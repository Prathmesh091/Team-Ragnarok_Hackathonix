...
export const LimelightNav = ({
    ...
    return (
        <nav className={`relative inline-flex items-center h-16 rounded-lg bg-gray-800/50 backdrop-blur-sm text-gray-100 border border-gray-700 px-2 ${className}`}>
            ...
            <div
                ref={limelightRef}
                className={`absolute top-0 z-10 w-11 h-[5px] rounded-full bg-green-500 shadow-[0_50px_15px_rgba(34,197,94,0.5)] ${isReady ? 'transition-[left] duration-400 ease-in-out' : ''
                    } ${limelightClassName}`}
                style={{ left: '-999px' }}
            >
